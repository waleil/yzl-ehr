...
import cn.net.yzl.ehr.config.mysql.DataSourceType;
...
//	@Before("execution(* cn.net.yzl.ehr.service..*.get*(..)) "
//			+ " and @annotation(cn.net.yzl.ehr.config.annotation.ReadDataSource) ")
@Before("execution(* cn.net.yzl.ehr.service..*.get*(..))")
	public void setReadDataSourceType() {
		//如果已经开启写事务了，那之后的所有读都从写库读
		if(!DataSourceType.write.getType().equals(DataSourceContextHolder.getReadOrWrite())){
...
//	@Before("execution(* cn.net.yzl.ehr.service..*.*(..)) "
//			+ " and @annotation(cn.net.yzl.ehr.config.annotation.WriteDataSource) ")
@Before("execution(* cn.net.yzl.ehr.service..*.save*(..)) "+" and execution(* cn.net.yzl.ehr.service..*.update*(..))")
	public void setWriteDataSourceType() {
	    DataSourceContextHolder.setWrite();
	}
