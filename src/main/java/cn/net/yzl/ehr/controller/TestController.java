...
public class TestController {
    ...
    @ApiOperation(value="测试薪资*100", notes="测试薪资*100",consumes= MediaType.MULTIPART_FORM_DATA_VALUE)
    @RequestMapping(value = "/getKey", method = RequestMethod.GET)
    public String getKey(){
        StaffAbnorRecordPo staffAbnorRecordPo=new StaffAbnorRecordPo();
        staffAbnorRecordPo.setAdjustBasicSalaryFront(100);
        staffAbnorRecordPo.setAdjustFullAttendanceSalaryFront(200);
        staffAbnorRecordPo.setAdjustSalaryFront(300);
//        redisTemplate.opsForValue().set(key, value);
        StaffAbnorRecordSalaryPo staffAbnorRecordSalaryPo=new StaffAbnorRecordSalaryPo();
        BeanUtils.copyProperties(staffAbnorRecordPo,staffAbnorRecordSalaryPo);
        BeanUtils.copyProperties(staffAbnorRecordSalaryPo,staffAbnorRecordPo);
        System.out.println(staffAbnorRecordPo.getAdjustBasicSalaryFront());
        return staffAbnorRecordPo.getAdjustBasicSalaryFront()+":"+staffAbnorRecordPo.getAdjustFullAttendanceSalaryFront()+":"+staffAbnorRecordPo.getAdjustSalaryFront();
    }
