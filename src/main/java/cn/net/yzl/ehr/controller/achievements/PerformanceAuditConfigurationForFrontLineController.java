...
@RequestMapping(value="/performanceAuditConfigurationForFrontLine")
@RestController
@Api(value = "一线管理-绩效配置查看", tags = {"一线管理-绩效配置查看"})
public class PerformanceAuditConfigurationForFrontLineController {
