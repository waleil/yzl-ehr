...
public class ProcessBeginController {
    ...
    ComResponse<Boolean> savePositiveApplay (@RequestBody @Validated ProcessStaffPositiveVo staffPositiveVo){


        return saveProcessService.savePositiveApplay(staffPositiveVo);
    }
    ...
    ComResponse<Boolean> saveDimissionApplay (@RequestBody @Validated ProcessStaffDimissionVo staffDimissionVo){

        return saveProcessService.saveDimissionApplay(staffDimissionVo);
    }
}
