...
public class StaffRecruitController {
    ...
    public ComResponse<Integer> updateResumeFollowTime(@RequestParam @NotNull @Min(0) Integer num,@CurrentStaffNo @ApiIgnore String staffNo) {
    ...
    public ComResponse<Integer> batchDistributeTask(@RequestBody @Validated List<RecruitedTaskPo> recruitedTaskPos,@CurrentStaffNo @ApiIgnore String staffNo) {
