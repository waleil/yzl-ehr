...
@Data
@ApiModel(value = "DepartSocialVo", description = "社保配置信息主类")
...
//    private String zoneName;
    ...
    @ApiModelProperty(value = "多少日后生效",name = "effect_day")
    ...
    @ApiModelProperty(value = "缴纳社保详情信息集合",name = "departSocialInfoPoList")
    @NotEmpty
